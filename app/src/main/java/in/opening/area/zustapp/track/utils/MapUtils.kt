package `in`.opening.area.zustapp.tracking.track.utils
...
object MapUtils {
    ...
    private const val TAG = "`in`.opening.area.zustapp.tracking.track.utils.MapUtils"

    fun getCarBitmap(context: Context): Bitmap {
        val bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.ic_baseline_my_location_24)
